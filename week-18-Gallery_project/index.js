window.addEventListener("DOMContentLoaded", () => {
  ...
  bigImage.style.backgroundImage = `url(${images[0].file})`;
  ...
  bigImage.appendChild(contentDiv);
  ...
  document.querySelectorAll(".thumbnail-item").forEach((div, i) => {
    div.addEventListener("click", () => {
      bigImage.style.backgroundImage = `url(${images[i].file})`;
  ...
  nextButton.addEventListener("click", () => {
    ...
    bigImage.style.backgroundImage = `url(${images[counter].file})`;
